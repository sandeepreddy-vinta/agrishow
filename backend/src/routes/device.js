...
const createRouter = (db) => {
    ...
    router.post('/heartbeat', deviceAuth, (req, res, next) => {
        try {
            const lastSync = db.transact((data) => {
     ...
     */
    router.get('/playlist', deviceAuth, (req, res) => {
     ...
     */
    router.post('/report', deviceAuth, (req, res, next) => {
        try {
    ...
    router.post('/franchises/:deviceId/heartbeat', deviceAuth, (req, res, next) => {
